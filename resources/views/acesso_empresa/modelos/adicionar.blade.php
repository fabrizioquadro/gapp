...
<div class="d-flex justify-content-between">
    <h4 class="card-title">Adicionar Modelo de Etapas</h4>
</div>
<hr>
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        <form action="{{ route('empresa.modelo_etapa.insert') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="form-floating form-floating-outline">
                        <input required class="form-control" type="text" id="nome" name="nm_modelo" placeholder="Nome do Modelo:"/>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-floating form-floating-outline">
                        <input id="etapas" class="form-control h-auto" name="etapas" value="" />
