...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        <form action="{{ route('empresa.clientes.update') }}" method="post">
            @csrf
            ...
            <div class="row mt-1 gy-4">
                <div class="col-md-4">
                    <div class="form-floating form-floating-outline">
                        <input required class="form-control" type="text" id="nr_cpf" name="nr_cpf" placeholder="CPF:" value="{{ $cliente->nr_cpf }}"/>
