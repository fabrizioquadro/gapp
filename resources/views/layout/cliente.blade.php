            ...
            <div class="layout-container">
                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    <div class="app-brand demo">
                        <a href="{{ route('cliente.dashboard') }}" class="app-brand-link">
                            ...
                            <ul class="navbar-nav flex-row align-items-center ms-auto">
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-medium d-block"><b>{{ $cliente->nm_cliente }}</b></span>
                                                    <small class="text-muted">{{ $cliente->empresa->nm_empresa }}</small>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('cliente.alterar_senha') }}">
