<!DOCTYPE html>
@php
$login_sessao = session()->get('login_sessao');
$empresa = session()->get('empresa');

if($login_sessao['tipo_login'] == "empresa"){
    if($empresa->imagem){
...
elseif($login_sessao['tipo_login'] == "usuario"){
...
<html lang="pt-BR" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('/public/template') }}/" data-template="vertical-menu-template">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('/public/template/vendor/libs/tagify/tagify.css') }}" />
    ...
    <body>
                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <ul class="menu-inner py-1">
                        ...
                        if($login_sessao['tipo_login'] == "empresa"){
                            @endphp
                            <li class="menu-item">
                                <a href="{{ route('empresa.configuracao') }}" class="menu-link">
                                    <i class="menu-icon tf-icons mdi mdi-cog-outline"></i>
                                    <div data-i18n="Configuração">Configuração</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('empresa.usuarios') }}" class="menu-link">
                        ...
                        @endphp
                        <li class="menu-item">
                            <a href="{{ route('empresa.clientes') }}" class="menu-link">
                                <i class="menu-icon tf-icons mdi mdi-account-star"></i>
                                <div data-i18n="Clientes">Clientes</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('empresa.modelo_etapa') }}" class="menu-link">
                                <i class="menu-icon tf-icons mdi mdi-arrange-send-backward"></i>
                                <div data-i18n="Mod. Etapas">Mod. Etapas</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('empresa.orcamentos') }}" class="menu-link">
                                <i class="menu-icon tf-icons mdi mdi-receipt-text-edit"></i>
                                <div data-i18n="Orçamentos">Orçamentos</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('empresa.projetos') }}" class="menu-link">
                                <i class="menu-icon tf-icons mdi mdi-format-list-bulleted"></i>
                                <div data-i18n="Projetos">Projetos</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('empresa.mensagens') }}" class="menu-link">
                                <i class="menu-icon tf-icons mdi mdi-message-outline"></i>
                                <div data-i18n="Mensagens">Mensagens</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('empresa.planos') }}" class="menu-link">
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                        <div class="avatar avatar-online">
                                            <img src="{{ asset($avatar) }}" style='max-height: 40px' alt class="w-px-40 h-auto rounded-circle" />
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    @if($login_sessao['tipo_login'] == "empresa")
                                                        <span class="fw-medium d-block">{{ $empresa->nm_empresa }}</span>
                                                        <small class="text-muted">Empresa</small>
                                                    @else
                                                        @if($login_sessao['tipo_login'] == "usuario")
                                                            <span class="fw-medium d-block">{{ $empresa->nm_empresa }}<br><b>{{ $usuario->nm_user }}</b></span>
                                        ...
                                        <li>
                                            @if($login_sessao['tipo_login'] == "empresa")
                                                <a class="dropdown-item" href="{{ route('empresa.perfil') }}">
                                                    <i class="mdi mdi-account-outline me-2"></i>
                                                    <span class="align-middle">Perfil</span>
                                                </a>
                                            @else
                                                @if($login_sessao['tipo_login'] == "usuario")
                                                <a class="dropdown-item" href="{{ route('empresa.usuario.perfil') }}">
                                                    <i class="mdi mdi-account-outline me-2"></i>
                                                    <span class="align-middle">Perfil</span>
                                                </a>
                                                @endif
                                        ...
                                        <li>
                                            @if($login_sessao['tipo_login'] == "empresa")
                                                <a class="dropdown-item" href="{{ route('empresa.alterar_senha') }}">
                                                    <i class="mdi mdi-lock-reset me-2"></i>
                                                    <span class="align-middle">Alterar Senha</span>
                                                </a>
                                            @else
                                                @if($login_sessao['tipo_login'] == "usuario")
                                                <a class="dropdown-item" href="{{ route('empresa.usuario.alterar_senha') }}">
                                                    <i class="mdi mdi-lock-reset me-2"></i>
                                                    <span class="align-middle">Alterar Senha</span>
                                                </a>
                                                @endif
        ...
        <script src="{{ asset('/public/template/vendor/libs/tagify/tagify.js') }}"></script>
