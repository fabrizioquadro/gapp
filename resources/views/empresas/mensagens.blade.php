        ...
        <div class="col app-chat-history">
            <div class="chat-history-wrapper">
                ...
                <div class="chat-history-body">
                    <ul class="list-unstyled chat-history">
                        @foreach($mensagens as $mensagem)
                            @php
                            $var = explode(' ', $mensagem->dt_hr_mensagem);
                            @endphp
                                    ...
                                    <div class="d-flex overflow-hidden">
                                        ...
                                        <div class="chat-message-wrapper flex-grow-1">
                                            ...
                                            <div class="text-end mt-1">
                                                <small>{{ dataDbForm($var[0])." ".$var[1] }}</small>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="chat-history-footer">
                    <form action="{{ route('admin.empresas.mensagens.insert') }}" class="form-send-message d-flex justify-content-between align-items-center" method="post">
                        @csrf
