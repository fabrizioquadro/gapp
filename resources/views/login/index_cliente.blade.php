...
<p class="mb-4">Área Cliente - Login</p>
...
@endif
<form id="formAuthentication" class="mb-3" action="{{ route('cliente.login') }}" method="POST">
    @csrf
    ...
    <div class="mb-3 d-flex justify-content-between">
        <a href="{{ route('cliente.recuperar_senha') }}" class="float-end mb-1">
