...
<p class="mb-4">Área Empresa - Login</p>
...
@endif
<form id="formAuthentication" class="mb-3" action="{{ route('empresa.login') }}" method="POST">
    @csrf
    ...
    <div class="mb-3 d-flex justify-content-between">
        <a href="{{ route('empresa.recuperar_senha') }}" class="float-end mb-1">
